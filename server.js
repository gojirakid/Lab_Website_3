...
//team stats page //zebra
app.get('/team_stats', function (req, res) {
    var query1 = 'SELECT * FROM football_games;';
    //var all_games= req.query.team_stats //or football_games //?
    var query2 = 'SELECT COUNt(*) AS total_wins FROM football_games WHERE home_score > visitor_score;'//count winning games in Fall 2020 season
    var query3 = 'SELECT COUNT(*) AS total_losses FROM football_games WHERE home_score > visitor_score;';
    db.task('get-everything', task => {
        ...
        .then(data => {
            res.render('pages/team_stats', {
                my_title: "FALL 2020 GAME STATS",
                result_1: data[0],
                result_2: data[1][0].total_wins,
                result_3: data[2][0].total_losses
            })
        })
        .catch(err => {
...
app.post('/home/pick_color', function (req, res) {
    ...
    db.task('get-everything', task => {
        ...
        .then(info => {
            res.render('pages/home', {
                my_title: "Home Page",
                data: color_choice,// Return the color choices zebra 
                color: color_hex,// Return the hex value of the color added to the table
                color_msg: chosen_color// Return the color message of the color added to the table
            })
        })
        .catch(err => {
            console.log('error', err);
